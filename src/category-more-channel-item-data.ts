...
export class CategoryMoreChannelItemData {
    ...
    static zero(): CategoryMoreChannelItemData {
        return new CategoryMoreChannelItemData(
            '',
            '',
            '',
            0,
    ...
    static toJson(entity: CategoryMoreChannelItemData): any {
        if (null == entity) {
            return null;
        }
